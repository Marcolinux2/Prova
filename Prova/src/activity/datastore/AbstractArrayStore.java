...
public abstract class AbstractArrayStore {
	...
	// HINT: The following are instance variables and are accessible directly by all
	...
	// The implementation of the following methods are delegated to subclasses. By
	// default they will
	...
	public AbstractArrayStore() {
		...
		// TODO Activity 2.0
		// Initialize the array 'store' that can hold a number of objects specified by
		// DEFAULT_SIZE
	...
	public AbstractArrayStore(int size) {
		...
		// Initialize the array 'store' that can hold a number of objects specified by
		// 'size'.
		// If the variable 'size' is in anyway illegal for an array, then use
		// DEFAULT_SIZE instead
	...
	public int find(Object arg) {
		...
		// there is any object
		// in the array that is equal to 'arg' according to equals() method. Return the
		// index where that
		// object is located or NOT_IN_STRUCTURE, if the object is not within
		// the array.

		// HINT: All objects have a method named equals()
